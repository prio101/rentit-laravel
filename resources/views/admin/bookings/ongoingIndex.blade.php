                ...
                <div class="col-md-12">
                    <div class="content-panel">
                        <table class="table table-striped table-advance table-hover">
                            <h4><i class="fa fa-angle-right"></i>Ongoing Bookings List</h4>
                            ...
                            @foreach($bookingsOngoing as $booking)
                                <tr>
                                    ...
                                    <td><span class="label label-warning label-mini">On Service</span></td>
                                    <td>
